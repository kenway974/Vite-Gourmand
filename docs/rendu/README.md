...
Documents exigés par l'énoncé pour l'ECF, à déposer ici. Les maquettes et
...
- `README.md` (racine) — déploiement local
- `sql/jeu-de-donnees.sql` — script SQL (création + jeu de données)
- `docs/maquettes/` — maquettes desktop et mobile
- `docs/charte-graphique/` — palette, typographie, contrastes
